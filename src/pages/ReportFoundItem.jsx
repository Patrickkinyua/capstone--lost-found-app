...
import { postFoundItem } from "../api-work/fetchinng";
...
function ReportFoundItem() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await postFoundItem(formData);
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-purple-50 to-purple-100 px-4 py-8">
        <form
          onSubmit={handleSubmit}
          className="bg-white rounded-xl shadow-md p-8 w-full max-w-lg border"
        >
          <h2 className="text-3xl font-bold mb-6 text-center">
            <span className="text-blue-700">Report</span>{" "}
            <span className="text-purple-700">Found Item</span>
          </h2>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              placeholder="e.g., Blue Notebook, Red Umbrella"
            />
            {errors.item && (
